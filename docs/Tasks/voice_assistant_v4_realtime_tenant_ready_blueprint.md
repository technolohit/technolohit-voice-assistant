...
| Item | Status |
|------|--------|
| **Current completed phase** | **Phase 10W — hard Gate 3 RAG-on preflight and product-opening recovery** |
...
| **Next step** | Release the Phase 10W image, rerun Gate 2 v4/RAG-off control, then run Gate 3 only after the hard in-container RAG preflight passes — [10W report](./voice_assistant_v4_phase10w_gate3_preflight_and_product_opening_report.md) |
...
**Status: Phases 10A–10W implemented; Phase 10W prevents invalid RAG-on canaries and repairs high-confidence Smart Website opening phrases; production v4 NOT globally enabled.**
